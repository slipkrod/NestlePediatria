<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Productos.aspx.cs" Inherits="NestlePediatria.Productos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <p style="padding-left:15px;">><a href="Mostrar.aspx">Inicio</a>> <a href="MenuVademecum.aspx">Menú Vademecum</a>> Productos</p>
    <div id="info_inicio">
    ...
    <br /><br />
    <asp:GridView ID="dgProductos" runat="server" DataKeyNames="id" AutoGenerateColumns="False" Height="47px"
                        Width="644px" OnRowCommand="dgProductos_RowCommand" OnRowDataBound="dgProductos_RowDataBound" BackColor="White" 
