...
CodeBehind="AddEditAnnales.aspx.cs" Inherits="NestlePediatria.AddEditAnnales" %>
...
<p style="padding-left:15px;">><a href="Mostrar.aspx">Inicio</a>> <a href="Annales.aspx">Annales</a>> Nuevo-Edición</p>
    <div id="articulos">
<br />
<asp:Label ID="lblMensaje" runat="server"></asp:Label><br />
    ...
    <tr>
        <td colspan="2">
        <a id="imageAnnales" runat="server">Ver Imagen</a>
    ...
    <input type="checkbox" id="CheckCcepta" class="validate[required] checkbox" runat="server" />
    </td>
