<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="Eventos.aspx.cs" Inherits="NestlePediatria.Eventos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <p style="padding-left: 15px;">
        ><a href="Mostrar.aspx">Inicio</a>> Eventos</p>
    <div id="info_inicio">
        <p>
        ...
        <br />
        <br />
        <asp:GridView ID="dgEventos" runat="server" DataKeyNames="id" AutoGenerateColumns="False"
            Height="47px" Width="644px" OnRowCommand="dgEventos_RowCommand" OnRowDataBound="dgEventos_RowDataBound"
