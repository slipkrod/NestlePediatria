<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Materiales.aspx.cs" Inherits="NestlePediatria.Materiales" %>
...
<p style="padding-left:15px;">><a href="Mostrar.aspx">Inicio</a>> Otros Materiales</p>
<div id="info_inicio">
<asp:LinkButton ID="LinkNuevo" runat="server" onclick="LinkNuevo_Click" class="boton">+ CREAR NUEVO</asp:LinkButton>
    ...
    <br /><br />
    <asp:GridView ID="dgMateriales" runat="server" DataKeyNames="id" AutoGenerateColumns="False" Height="47px"
                        Width="644px" OnRowCommand="dgMateriales_RowCommand" OnRowDataBound="dgMateriales_RowDataBound"
                        BackColor="White" 
