<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="AddEditArticulo.aspx.cs" Inherits="NestlePediatria.AddEditArticulo" %>
...
<p style="padding-left:15px;">><a href="Mostrar.aspx">Inicio</a>><a href="MenuArticulos.aspx">Menu Artículos</a>> <a href="Articulos.aspx">Artículos</a>> Nuevo-Edición</p>
...
<asp:Label ID="lblMensaje" runat="server"></asp:Label><br />
    ...
    <tr>
        <td>Fecha:</td>
        <td><div id="dateFc"></div><asp:TextBox ID="txtFecha" runat="server" onclick="dater('dateFc','ctl00_ContentPlaceHolder1_txtFecha');" CssClass="validate[required,custom[date]] "></asp:TextBox></td>
    </tr>
    <tr>
        <td>Categoría: </td>
        <td>
            <asp:DropDownList ID="DropDawnCategoria" runat="server">
            </asp:DropDownList>
        </td>
    </tr>
    <tr>
        <td colspan="2">
            <a id="imageArticulo" runat="server">Ver Imagen</a>
        </td>
    </tr>
    <tr>
