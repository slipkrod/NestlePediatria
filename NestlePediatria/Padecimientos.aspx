<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Padecimientos.aspx.cs" Inherits="NestlePediatria.Padecimientos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
     ...
     <p style="padding-left:15px;">><a href="Mostrar.aspx">Inicio</a>> <a href="MenuVademecum.aspx">Menú Vademecum</a>> Padecimientos</p>
      <div id="info_inicio">
  ...
  <br />
    ...
    <asp:GridView ID="dgPadecimientos" runat="server" DataKeyNames="id" AutoGenerateColumns="False" Height="47px"
                        Width="644px" OnRowCommand="dgPadecimientos_RowCommand" OnRowDataBound="dgPadecimientos_RowDataBound" BackColor="White" 
