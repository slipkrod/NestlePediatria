...
namespace NestlePediatria
{
    public partial class Materiales : System.Web.UI.Page
    {
        ...
        protected void dgMateriales_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "btnEditar")
            {
                try
                {
                    ...
                    Response.Redirect("AddEditMaterial.aspx?idMaterial=" + id);
        ...
        protected void dgMateriales_RowDataBound(object sender, GridViewRowEventArgs e)
        {
        ...
        {
            Response.Redirect("AddEditMaterial.aspx");
        }

        protected void CargaMateriales()
        {
            List<Material> materialGrid = MaterialDAO.Consulta(int.Parse(Session["id"].ToString()), int.Parse(Session["rol"].ToString()));
            dgMateriales.DataSource = materialGrid;
