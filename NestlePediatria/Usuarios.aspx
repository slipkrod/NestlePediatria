<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Usuarios.aspx.cs" Inherits="NestlePediatria.Usuarios" %>
...
<p style="padding-left:15px;">><a href="Mostrar.aspx">Inicio</a>> Usuarios</p>
<div id="info_inicio">
<asp:LinkButton ID="linkNuevo" runat="server" onclick="linkNuevo_Click1" class="boton">+ CREAR NUEVO</asp:LinkButton>
    <br />
    <br />
    <asp:Label ID="lblConfirmacion" runat="server" Text=""></asp:Label>
    <br /><br />
<asp:GridView ID="dgUsuarios" runat="server" DataKeyNames="id" AutoGenerateColumns="False" Height="47px"
                        Width="644px" OnRowCommand="dgUsuarios_RowCommand" OnRowDataBound=" dgUsuarios_RowDataBound" BackColor="White" 
