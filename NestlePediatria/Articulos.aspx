<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Articulos.aspx.cs" Inherits="NestlePediatria.Articulos" %>
...
<p style="padding-left:15px;">><a href="Mostrar.aspx">Inicio</a>><a href="MenuArticulos.aspx">Menu Artículos</a>> Artículos</p>
<div id="info_inicio">
    ...
    <br /><br />
    <asp:GridView ID="dgArticulos" runat="server" DataKeyNames="id" AutoGenerateColumns="False" Height="47px"
                        Width="644px" OnRowCommand="dgArticulos_RowCommand" OnRowDataBound="dgArticulos_RowDataBound"
                        BackColor="White" 
        ...
        GridLines="Horizontal" >
                        <Columns>
                            ...
                            <asp:BoundField DataField="nombre" HeaderText="Nombre Evento" />
