<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Categorias.aspx.cs" Inherits="NestlePediatria.Categorias" %>
...
<p style="padding-left:15px;">><a href="Mostrar.aspx">Inicio</a>> <a href="MenuArticulos.aspx">Menu Artículos</a>> Categorías</p>
 <div id="info_inicio">
    <asp:LinkButton ID="linkNuevo" runat="server" onclick="linkNuevo_Click" class="boton">+ CREAR NUEVA</asp:LinkButton>
    <br />
    <asp:Label ID="lblConfirmacion" runat="server" Text=""></asp:Label>
    <br /><br />
    <asp:GridView ID="dgCategorias" runat="server" DataKeyNames="id" AutoGenerateColumns="False" Height="47px"
                        Width="644px" OnRowCommand="dgCategorias_RowCommand" OnRowDataBound="dgCategorias_RowDataBound" BackColor="White" 
