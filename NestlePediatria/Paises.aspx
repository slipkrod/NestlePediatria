<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Paises.aspx.cs" Inherits="NestlePediatria.Paises" %>
...
<p style="padding-left:15px;">><a href="Mostrar.aspx">Inicio</a>> Paises</p>
<div id="info_inicio">
    ...
    <br /><br />
    <asp:GridView ID="dgPaises" runat="server" DataKeyNames="id" AutoGenerateColumns="False" Height="47px"
                        Width="644px" OnRowCommand="dgPaises_RowCommand" OnRowDataBound=" dgPaises_RowDataBound" BackColor="White" 
