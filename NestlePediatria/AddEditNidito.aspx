<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="AddEditNidito.aspx.cs" Inherits="NestlePediatria.AddEditNidito" %>
...
<p style="padding-left:15px;">><a href="Mostrar.aspx">Inicio</a>> <a href="Nidito.aspx">Nidito</a>> Nuevo-Edición</p>
<div id="articulos">    
<br />
<asp:Label ID="lblMensaje" runat="server"></asp:Label><br />
    ...
    <tr>
        <td colspan="2">
            <a id="imageNidito" runat="server" target="_blank" visible="false">Ver Imagen</a>
        </td>
    </tr>
    <tr>
