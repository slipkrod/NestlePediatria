<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Nidito.aspx.cs" Inherits="NestlePediatria.Nidito" %>
...
<p style="padding-left:15px;">><a href="Mostrar.aspx">Inicio</a>> Nidito</p>
<div id="info_inicio">
    ...
    <br /><br />
    <asp:GridView ID="dgNidito" runat="server" DataKeyNames="id" AutoGenerateColumns="False" Height="47px"
                        Width="644px" OnRowCommand="dgNidito_RowCommand" OnRowDataBound="dgNidito_RowDataBound"
                        BackColor="White" 
